...
| ------------------------------------------- | ---------------------------- | ---------- | --------- |
| Variantes de déplacement des ennemis        | Stratégie                    |            | Romain    |
| Gestion des points de vie (ennemis, joueur) | Décorateur                   |            |           |
| Invulnérabilité du joueur                   | Etat                         |            | Mattéo    |
| Solidité des murs                           | Etat                         |            | Théo M.   |
| Variantes de génération pour la carte       | Stratégie                    |            | Théo M.   |
| Différents types de bombes                  | Stratégie                    |            | Théo D.   |
